...
# User Inputs
initial_investment = initial_investment = st.number_input("Initial Investment Amount", min_value=1000, value=10000, step=1000)
st.write(f"**Formatted Amount:** ${initial_investment:,.0f}")
